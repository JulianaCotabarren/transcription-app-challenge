/* Componente encargado de la reproducción del audio. */
'use client'
...
export default function AudioPlayer (): JSX.Element {
  ...
  // Inicialización del waveform y carga del audio.
  useEffect(() => {
  ...
  // Sincronización del tiempo de reproducción del audio con el waveform.
  useEffect(() => {
    if (waveform == null) return
  ...
  return (
    <section className={`fixed top-3 ${!isBottomWindow ? 'max-[600px]:top-0' : 'max-[600px]:-top-20'} right-6 max-[600px]:right-0 max-[600px]:left-0 max-[600px]:mx-6 flex p-8 rounded-full ring-1 ring-neutral-50 max-h-[60px] after:absolute after:inset-0 after:bg-bckg/80 max-[600px]:after:bg-bckg after:size-full after:rounded-full transition-all  duration-300 ease-out`}>
